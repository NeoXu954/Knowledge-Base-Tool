...
client = ZhipuAI(api_key="83895ac6038ca7b23bdf2ea8a12122fb.Io4aDgvikY4AfsTg") # 填写您自己的APIKey
...
def chat(question, history, local_text):
    ...
    if local_text:
        ...
        chat_history.append(
            {"role": "system",
             "content": f"""你是生活实验室的零号讲解员，请你基于我提供的文档进行分析总结，获取关键内容，回答我的问题。
                        现在，我会将需要阅读的文档以文字的形式提供给你，有多个文件。具体内容如下:
                        {local_text}
                        """},
        )
